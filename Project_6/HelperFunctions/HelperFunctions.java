package B_Projects.Project_6.HelperFunctions;
import B_Projects.Project_6.Database.Address;
...
public class HelperFunctions {
    ...
    public static String generateShippingTrackingNumber
            (String fullname, String city, String zipcode) {
        ...
        String code = ilkUcHarf + checkZipCode(zipcode) + basHarf;
